...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>BlockDevs DAO</title>
        <meta name="description" content="BlockDevs DAO" />
      ...
      <div className={styles.main}>
        <div>
          ...
          <div className={styles.description}>
            Your BlockDevs NFT Balance: {nftBalance}
            <br />
      ...
      <footer className={styles.footer}>
        Made with <span className={styles.heart}>&hearts;</span> by Weird-AL
      </footer>
    </div>
  );
}
